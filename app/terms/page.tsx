      ...
      <section className="pt-10 pb-20 px-4 bg-white">
        <div className="mx-auto max-w-full px-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">3. Your Account:</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">4. User Conduct</h3>
              <div className="flex flex-col gap-1 text-muted-foreground" style={{ fontSize: "clamp(13px, 1.1vw, 17px)" }}>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">5. User Contributions</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">6. CRV Score™</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">7. Third-Party Services</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">8. Disclaimer of Warranties</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">9. Limitation of Liability</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">10. Indemnification</h3>
              <p className="text-muted-foreground leading-relaxed mb-3" style={{ fontSize: "clamp(13px, 1.1vw, 17px)" }}>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">11. Termination</h3>
              <p className="text-muted-foreground leading-relaxed mb-3" style={{ fontSize: "clamp(13px, 1.1vw, 17px)" }}>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">12. Governing Law</h3>
              <p className="text-muted-foreground leading-relaxed mb-3" style={{ fontSize: "clamp(13px, 1.1vw, 17px)" }}>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">13. Changes to Terms</h3>
              <p className="text-muted-foreground leading-relaxed mb-3" style={{ fontSize: "clamp(13px, 1.1vw, 17px)" }}>
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">14. Contact Us</h3>
              <p className="text-muted-foreground leading-relaxed mb-3" style={{ fontSize: "clamp(13px, 1.1vw, 17px)" }}>
                Email:{" "}
