        ...
        <div className="relative flex flex-col items-center justify-center text-center lg:text-left py-6 lg:py-0" style={{ paddingRight: "clamp(8px, 2vw, 32px)" }}>
          ...
          <div className="justify-center lg:justify-start" style={{ marginTop: "clamp(20px, 3vw, 48px)", display: "flex", flexWrap: "wrap", gap: "clamp(8px, 1.2vw, 16px)", alignItems: "stretch" }}>
            <a
              ...
              style={{ gap: "clamp(6px, 0.8vw, 12px)", borderRadius: "clamp(12px, 1.2vw, 18px)", padding: "clamp(8px, 0.9vw, 14px) clamp(8px, 1vw, 16px)" }}
            >
              <svg viewBox="0 0 24 24" className="shrink-0" style={{ width: "clamp(22px, 2vw, 32px)", height: "clamp(22px, 2vw, 32px)" }} aria-hidden="true">
              ...
              <div className="text-left">
                ...
                <div style={{ fontFamily: "var(--font-poppins), Poppins, sans-serif", fontWeight: 500, fontSize: "clamp(12px, 1.2vw, 18px)", lineHeight: "140%" }}>Google Play</div>
              </div>
            </a>
            <a
              href="#"
            ...
            >
              ...
              <div className="text-left">
                <div className="text-gray-400 leading-none" style={{ fontFamily: "var(--font-poppins), Poppins, sans-serif", fontWeight: 500, fontSize: "clamp(8px, 0.8vw, 12px)" }}>Download on the</div>
                <div style={{ fontFamily: "var(--font-poppins), Poppins, sans-serif", fontWeight: 500, fontSize: "clamp(12px, 1.2vw, 18px)", lineHeight: "140%" }}>App Store</div>
              </div>
            </a>
          </div>
          </div>
